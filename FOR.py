# EXERCÍCIO DE CONTROLE DE ESTOQUE, PERCORRENDO LISTAS DENTRO DE LISTAS.
...
for i, lista in enumerate(estoque):
    for qtde in lista:
        if qtde < nivel_minimo:
            print('O fabricas {} ficou abaixo do nivel minimo com o estoque {}'.format(fabricas[i], qtde))
